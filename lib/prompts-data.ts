...
export const prompts: Prompt[] = [
  ...
  },
  {
    ...
    "category": "Crie suas imagens de figurinhas da Copa",
    "prompt": "Gere uma imagem simulando um card de futebol colecionável antigo da Copa do Mundo dos anos [70/80]. O layout deve aplicar uma paleta de cores analógicas ligeiramente lavadas, grão de filme sutil, cantos levemente desgastados and uma textura de papel envelhecido que reforce a estética vintage."
  },
...
// 1. Extrai apenas as categorias reais dos dados informados acima
